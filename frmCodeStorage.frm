...
Private Sub cmdAddItem_Click()
    ...
    s = InputBox("הקלד שם פריט שברצונך להוסיף", "פריט חדש", "פריט חדש")
...
Private Sub txtCode_DragDrop(source As Control, X As Single, Y As Single)
    ...
    If LenB(Trim(Me.txtCode.Text)) > 0 Then
        If MsgBox("האם אתה בטוח שברצונך להחליף את הקוד הנוכחי בקוד החדש ?", vbYesNo Or vbMsgBoxRight Or vbMsgBoxRtlReading Or vbQuestion) = vbNo Then
            Exit Sub
        End If
    End If
